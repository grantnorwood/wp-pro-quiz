WP Pro Quiz (grantnorwood)
==========================

## Description

A powerful and beautiful quiz plugin for WordPress, originally created by [xeno010](http://profiles.wordpress.org/xeno010/), and hacked a bit by me.  If something is broken, it's probably my fault, so don't blame him.  See [http://wordpress.org/plugins/wp-pro-quiz/](http://wordpress.org/plugins/wp-pro-quiz/) for the official, original plugin.

Want to donate some cash to the original author?  I encourage you to do so via [PayPal](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=N9B7S4FT8CE2N)!
...
*		German / deutsch
*		Greek / e??????? (Thanks ?a?a??a? S.)
*		Norwegian / norsk (Thanks Stein Ivar J.)
*		Russian / ??????? (Thanks Sergei B. and Alex A.)
*		Spanish / español (Thanks Carlos R.)
*		Swedish / svenska (Thanks Martin J.)

### Live Demo
[http://www.it-gecko.de/wp-pro-quiz-quiz-plugin-fuer-wordpress.html](http://www.it-gecko.de/wp-pro-quiz-quiz-plugin-fuer-wordpress.html) (scroll to "Demo")
...
* Translation for greek have been added (Thanks ?a?a??a? S.)
